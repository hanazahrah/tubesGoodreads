...
<style>
  ...
  .gr-mediaFlexbox_media {
    flex-shrink: 0;
    align-self: flex-start;
    margin-right: 8px;
  }
  .gr-mediaFlexbox_desc{
    -webkit-box-flex: 1;
    flex-grow: 1;
  ...
  .currentlyReadingShelf_discoveryLinks{
    margin: 12px 0 0;
  }
  .u-marginBottomSmall{
    margin-bottom: 12px;
  ...
  .readingChallengeBadge .badgeYear {
    padding-top: 3px;
    padding-bottom: 6px; 
  }
  .readingChallengeBadge .badgeYear{
  ...
  input[type=text], input[type=number], input[type=search], input[type=email], input[type=number], input[type=password], textarea {
    background: #FFFFFF;
    border-radius: 3px;
  ...
  .userShelvesBookCounts{
    line-height: 150%;
    font-size:14px;
  }
  .userShelvesBookCounts_counts{
    padding-right: 12px;
    text-align: right;
    float: left;
  ...
  .userShelvesBookCounts_nameLink{
    display: block;
    text-overflow: ellipsis;
    overflow: hidden;
    white-space: nowrap;
  }
  .userShelvesBookCounts_buffer{
    clear: left;
  }
  .homeMiddleColumn{
    width: 460px;
  ...
  .gr-editorialBlogPost_likesAndComments {
    margin: 8px 0;
  }
  small, .gr-metaText{
    color: #767676;
  ...
  .gr-footer_layoutLink--mobile {
    margin-right: 4px;
  }
  .gr-footer_layoutLink {
    vertical-align: top;
  }
</style>
<div class="container">
  <div class="row">
    <div class="col-sm-3">
        ...
        <div>
          <section class="currentlyReadingShelf">
            ...
            <div class="gr-mediaFlexbox gr-mediaFlexbox--alignItemsCenter">
              <img class="gr-mediaFlexbox_media" src="assets/home/books2.png" border="0">
          ...
          <div class="readingChallenge_edit">
            ...
            <div class="gr-mediaBox">
              <div class="gr-mediaBox_media u-marginRightMedium">
                <img class="gr-mediaFlexbox_media" src="assets/home/readingChallenge.png">
              </div>
      ...
      <section class="gr-homePageRailContainer u-paddingBottomMedium showForLargeWidth">
        ...
        <div class="shelfDisplay">
          <div class="gr-mediaFlexbox gr-mediaFlexbox--alignItemsCenter">
            <img class="gr-mediaFlexbox_media" src="assets/home/booksread.png">
        ...
        <div class="u-positionRelative">
          <button class="gr-iconButton u-floatRight" aria-label="Customize updates feed preferences" aria-haspopup="true" aria-expanded="false" aria-controls="grNewsfeedPreferences">
            <span class="gr-iconButton_innerWrapper">
              <img class="gr-settingsIcon" src="assets/home/settings.png">
    ...
    <div class="col-sm-3">
      <section class="gr-homePageRailContainer u-paddingBottomMedium">
        <section class="gr-editorialBlogPost">
          <article>
            ...
            <img src="assets/home/newsbooks.png">
      ...
      <section class="gr-homePageRailContainer u-paddingBottomMedium">
        ...
        <img src="assets/home/recommendation.png">
      </section>
      <section class="gr-homePageRailContainer u-paddingBottomMedium">
      ...
      <section class="gr-homePageRailContainer u-paddingBottomMedium">
        <img src="assets/home/choice.png">
      </section>
      <footer>
        ...
        <a class="gr-footer_socialLink"><img src="assets/home/facebook.png"></a>
        <a class="gr-footer_socialLink"><img src="assets/home/twitter.png"></a>
        <a class="gr-footer_socialLink"><img src="assets/home/instagram.png"></a>
        <a class="gr-footer_socialLink"><img src="assets/home/linkedin.png"></a>
        <div class="gr-footer_applinks">
          <a  style="margin-right: 16px;"><img src="assets/home/appstore.png"></a>
          <a><img src="assets/home/googleplay.png"></a>
          <p>
